...
#ifndef JAXLIB_CUDA_CUTEDSL_COLLECTIVE_FFI_H_
#define JAXLIB_CUDA_CUTEDSL_COLLECTIVE_FFI_H_
...
namespace jax::cuda::cutedsl::internal {
...
#endif  // JAXLIB_CUDA_CUTEDSL_COLLECTIVE_FFI_H_
