...
#ifndef JAXLIB_CUDA_CUTEDSL_COLLECTIVE_CONFIG_H_
#define JAXLIB_CUDA_CUTEDSL_COLLECTIVE_CONFIG_H_
...
// Parses and validates the required flat v3 attributes, ignores additional
// attributes, and copies all string-backed data into `config`.
absl::StatusOr<CollectiveCallConfigV3> ParseCollectiveCallConfigV3(
    const xla::ffi::Dictionary& attributes);

}  // namespace jax::cuda::cutedsl

#endif  // JAXLIB_CUDA_CUTEDSL_COLLECTIVE_CONFIG_H_
